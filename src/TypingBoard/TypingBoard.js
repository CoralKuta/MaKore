...
function TypingBoard({setter}) {
  ...
  return (
    <div className="gray-low-panel d-flex">
      <svg id="attachBtn" xmlns="http://www.w3.org/2000/svg" className="bi bi-paperclip" viewBox="0 0 16 16">
      ...
      <svg onClick={send} xmlns="http://www.w3.org/2000/svg" className="bi bi-send" viewBox="0 0 16 16" >
