...
function TypingBoard({ setter }) {
  ...
  function typing() {
    ...
    textarea.addEventListener("keyup", e => {
      if (e.key = 'Enter' && textarea.current.value == ''){return}
...
const cleanTextarea = function(){
  ...
  return (
    <div className="gray-low-panel d-flex" id="grayPanel" style={{ 'height': height }}>
      ...
      <textarea onKeyPress={handleKeypress} onChange={typing} ref={textBoard} className="message-board w-80" placeholder="New message here..."></textarea>
