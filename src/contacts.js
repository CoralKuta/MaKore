...
let Gal = { Username: "Gal", Nickname: "Idota", password: "12341234", pic: img, friends: [Matan], time : "11:31", massage : "Hey there! im using MaKore", noti : 0 }

let contacts = [
    { Username: "Tal", Nickname: "Tal!", password: "1234567890", pic: img, friends: [Matan], time : "11:31", massage : "Hey there! im using MaKore", noti : 3 },
    { Username: "Coral", Nickname: "Kuta", password: "12345678", pic: img, friends: [Gal, Matan], time : "11:31", massage : "Hey there! im using MaKore", noti : 3 },
